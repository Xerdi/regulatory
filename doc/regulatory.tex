...
\noindent
\translation{%
    The \texttt{xfail} case fails ISO 19005-3 rule 6.8-4 on a file specification for the external
    ...
    Het \texttt{xfail} geval faalt op regel 6.8-4 van ISO 19005-3, op een bestandsspecificatie voor
