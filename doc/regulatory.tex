...
\begin{abstract}
    ...
    \translation{%
        ...
        When it comes to referencing definitions, \package{regulatory} package aligns with the existing \cmd{\gls} macro family of the \package{glossaries} package.%
    }{%
...
\DescribeEnv{paras}
\translation{%
    For the \option{paras} and ``subparagraphs'', a new environment has been created using \package{enumitem}.
...
\translation{%
    ...
    De \cmd{\rref@setup} macro heeft als eerste argument \meta{de taal} die ingesteld dient te worden.
...
\begin{labeling}{\texttt{group conjunction}}
    ...
    \item[Name] \translation{%
        ...
        de benaming beginnend met een hoofdletter.
