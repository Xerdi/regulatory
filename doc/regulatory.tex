...
\translation{%
    Eight documents are typeset, of which two exist in both languages, so a suite makes nine of
    them per engine and four in the conversion of \zcref{sec:html}. One of the eight is converted
    ...
    Er worden acht documenten gezet, waarvan twee in beide talen bestaan, zodat een suite er
    negen per engine maakt en vier in de omzetting van \zcref{sec:html}. Eén van de acht wordt
...
\translation{%
    Every engine suite ends in eight sets of assertions, each of which prints what it counted and
    ...
    Iedere engine-suite eindigt in acht reeksen controles, die elk opschrijven wat ze geteld
    ...
    zijn taak is om diezelfde stilte de volgende keer hoorbaar te maken. Alle acht zijn expres
