...
\begin{labeling}{\option{nameinlink}\quad\texttt{voluit}}
    \addtokomafont{labelinglabel}{\ttfamily}
    ...
    \item[bronstijl\quad voluit] \translation{%
        whether a citation of an external source is written out or abbreviated; see \zcref{sec:sources}.%
    }{%
        of een aanhaling van een externe bron voluit of verkort geschreven wordt; zie
        \zcref{sec:sources}.%
    }
\end{labeling}
\translation{%
