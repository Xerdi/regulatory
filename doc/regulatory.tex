...
\translation{%
    ...
    A citation names one provision. An enumeration of them\,---\,\enquote{onderdelen c en d},
    \enquote{Buchstaben a bis c}\,---\,is the next thing this module needs, and the conjunctions it asks
    for are not the ones of \zcref{sec:ref}: they belong to the register of the instrument.
    ...
    Een verwijzing noemt één bepaling. Een opsomming ervan\,---\,\enquote{onderdelen c en d},
    \enquote{Buchstaben a bis c}\,---\,is het volgende dat deze module nodig heeft, en de voegwoorden
    daarvoor zijn niet die van \zcref{sec:ref}: ze horen bij het register van het instrument.
