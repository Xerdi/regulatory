...
\translation{%
    Five documents are typeset, of which two exist in both languages, so a suite makes seven of
    ...
    Er worden vijf documenten gezet, waarvan twee in beide talen bestaan, zodat een suite er
    zeven maakt. Ieder daarvan is een driver die de taal instelt, de artefacten declareert en de
...
\translation{%
    Every engine suite ends in six sets of assertions, each of which prints what it counted and
    ...
    Iedere engine-suite eindigt in zes reeksen controles, die elk opschrijven wat ze geteld
    ...
    zijn taak is om diezelfde stilte de volgende keer hoorbaar te maken. Alle zes zijn expres
