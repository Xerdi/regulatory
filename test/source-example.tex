...
% Elke bron in dit bestand is nagelopen op 2024-01-01, en dit document spreekt
% per diezelfde dag: er is dus niets veranderd tussen de twee.
...
\begin{document}
    ...
    % Dezelfde twee aanhalingen met de Engelse sleutelnamen. De Nederlandse zijn
    % aliassen van deze, dus beide regels horen woord voor woord hetzelfde op te
    % leveren; verschilt er iets, dan is de alias niet wat hij zegt te zijn.
