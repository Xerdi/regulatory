...
\begin{paras}
    ...
    \begin{paras}
        ...
        \item \label{sub:lorem8} \textfill~\Aref{ex2-lid:met spatie, ex2-lid:lorem}.
        \item \label{sub:lorem9} \textfill~\Aref{art:defs,art:lorem}.
    \end{paras}
\end{paras}
...
\textfill~\translation{See the attached}{Zie de bijgevoegde} \attachdocument[\translation{Definitions of this document}{Definities van dit document}]{example1.bib}{example1.bib}.
